...
const INPUT: usize = 69;
const OUTPUT: usize = 1;

const PRECISION: usize = 22;
const SIZE: usize = 7 + PRECISION + 1;
const LAYER_1: usize = 7 + PRECISION + 1;
const LAYER_2: usize = 7 + PRECISION + 1;
...
fn execute() {
    ...
    let mut model: ModelType<SIZE, PRECISION, INPUT, OUTPUT> =
        ModelBuilder::new(
            FFFFLayerType::<SIZE, LAYER_1, PRECISION, 50, OUTPUT, _, _>::new_random(
                &mut rng,
                af.clone(),
                loss_fn,
                &server_ctx,
        ...
        .add_layer(
            FFFFLayerType::<SIZE, LAYER_2, PRECISION, 50, 50, _, _>::new_random(
                &mut rng,
                af,
                loss_fn,
                &server_ctx,
        ...
        .add_layer(
            FFFFLayerType::<SIZE, LAYER_2, PRECISION, INPUT, 50, _, _>::new_random(
                &mut rng,
                af,
                loss_fn,
                &server_ctx,
