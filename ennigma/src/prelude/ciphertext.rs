...
use numbers::{Gen1DArray, Gen2DArray};
...
> = Model<EncryptedFixedPointNumber<SIZE, PRECISION>, ContextType, INPUT_N, OUTPUT_N>;
...
pub type Gen2DArrayType<
    ...
    const ROWS: usize,
    const COLS: usize,
> = Gen2DArray<EncryptedFixedPointNumber<SIZE, PRECISION>, ContextType, ROWS, COLS>;
pub type Gen1DArrayType<const SIZE: usize, const PRECISION: usize, const ROWS: usize> =
    Gen1DArray<EncryptedFixedPointNumber<SIZE, PRECISION>, ContextType, ROWS>;
